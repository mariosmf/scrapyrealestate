...
class FotocasaSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield scrapy.Request(f'{self.start_urls}',meta={
                    'playwright': True,
                    'playwright_context': 'fotocasa',                   
                    "playwright_page_methods": [
                    # click on the first product card
                    PageMethod("wait_for_selector", ".re-CardPackAdvance"),
                ],
                })
    ...
    def parse(self, response):
        ...
        test = response.css('article.re-CardPackAdvance')
        ...
        for nflat in range(len(flats)):
            ...
            try:
                ...
                href = flats[nflat].find("a", {"class": "re-CardPackAdvance-info"}, href=True)[
